    ...
    <header className="fixed top-0 left-64 right-0 h-16 bg-surface/80 backdrop-blur-md border-b border-border z-30">
      <div className="h-full px-6 flex items-center justify-between">
        ...
        <div className="flex items-center gap-4">
          <div>
            <h1 className="font-serif text-lg text-text">Palm Beach Residence</h1>
            <p className="text-xs text-silver-500">1200 South Ocean Boulevard</p>
          </div>
        </div>

        {/* Center: Status Indicators */}
        <div className="flex items-center gap-3">
          <div className="flex items-center gap-1.5 px-3 py-1.5 rounded-full bg-status-secure/10 text-status-secure text-xs font-medium">
          ...
          <div className="flex items-center gap-1.5 px-3 py-1.5 rounded-full bg-silver/10 text-silver-400 text-xs font-medium">
            ...
            {mockSystemStatus.climate.temperature}°F
          </div>
        </div>
